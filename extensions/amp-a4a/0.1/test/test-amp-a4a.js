...
import {data as minimumAmpData} from
    './testdata/minimum_valid_amp.reserialized';
import {data as regexpsAmpData} from './testdata/regexps.reserialized';
import {data as validCSSAmpData} from
    './testdata/valid_css_at_rules_amp.reserialized';
import {data as testFragments} from './testdata/test_fragments';
import {data as expectations} from './testdata/expectations';
import * as sinon from 'sinon';

/** @private @const Module ID tag for debug log messages */
const TAG_ = 'test-amp-a4a';
        ...
        return createIframePromise().then(fixture => {
          ...
          return a4a.adPromise_.then(() => {
            ...
            const state = JSON.parse(reason.message.substring(
              reason.message.indexOf('{'), reason.message.lastIndexOf('}')+1));
