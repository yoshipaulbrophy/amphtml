...
export class Extensions {
   ...
   * @private
   */
  insertExtensionScriptIfNeeded_(extensionId, extensionVer, holder, stubElement) {
    if (this.isExtensionScriptRequired_(extensionId, holder)) {
      const scriptElement = this.createExtensionScript_(extensionId, extensionVer);
  ...
  createExtensionScript_(extensionId, extensionVer) {
    ...
    const scriptSrc = calculateExtensionScriptUrl(loc, extensionId,
        extensionVer, getMode().localDev, getMode().test, useCompiledJs);
